                ...
                <main className="flex-grow pb-4 overflow-x-hidden overflow-y-auto flex flex-col space-y-4 scrollbar-hide">
                    <section className="flex flex-col">
                        <NavLink 
                            to="/dashboard/home" 
                            onClick={() => setMobileViewOpen(false)} 
                            className={({ isActive, isPending }) => (`${isActive ? "bg-orange-500 text-white" : "text-black hover:bg-neutral-100 dark:hover:bg-slate-800"} py-3 px-4 dark:text-white flex items-center ${reduceWidth ? 'mx-auto rounded-md' : 'space-x-2'}`)}
                        >
                            <>
