        ...
        <>
            <div className='w-4/6 md:w-2/4 mx-auto p-3 text-center'>
                ...
                <div className="my-2 flex items-center justify-center space-x-2">
                    <hr className="bg-orange-400 h-[2px] w-[40px] border-0" />
            ...
            > 
                ...
                <div className='form-sect mb-4 md:mb-3 lg:mb-5 flex justify-start items-center space-x-3'>
                    ...
                    <Link to='#' className='flex justify-start items-center space-x-3 text-black dark:text-white' onClick={() => handleShowPassword(!showPassword)}>
                        <p>Reveal Password</p>
                    </Link>
                </div>
                <button 
                    ...
                    type='submit' 
                    className={`${!isLoading ? 'bg-orange-400' : 'bg-orange-400 animate-pulse'} text-white p-3 rounded-md shadow-sm focus:ring-4 focus:ring-red-200 transition ease-in-out delay-150`}
                >
