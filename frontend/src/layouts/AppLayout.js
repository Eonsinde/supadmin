    ...
    return (
        <ProtectedView>
            <section className="">
                ...
                />
                <main className={`${reduceWidth ? 'ml-0 md:ml-[80px]' : 'ml-0 md:ml-[300px]'} h-screen py-2 px-4 md:px-6 bg-neutral-200/70 dark:bg-slate-800 overflow-hidden transition-all duration-100 ease-in-out`}>
                    <section className='h-full flex flex-col space-y-4 md:space-y-5'>
